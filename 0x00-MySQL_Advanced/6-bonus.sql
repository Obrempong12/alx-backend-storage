-- An SQL script to create a stored procedure named AddBonus. This procedure adds a new correction record for a student.
-- Inputs:
...
-- Changes the delimiter to avoid conflicts with semicolons in the procedure
DELIMITER $$
...
BEGIN
    ...
    -- Attempts to find the project by name and store its ID
